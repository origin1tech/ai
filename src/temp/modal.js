...
var modal = angular.module('ai.module.modal', []);

modal.run([function () {

}]);

modal.factory('AiModalFactory', ['$rootScope', '$http', '$q', '$compile', '$controller', '$templateCache', '$timeout', '$document', '$animate', '$window', '$injector',
    function ($rootScope, $http, $q, $compile, $controller, $templateCache, $timeout, $document, $animate, $window, $injector) {
	    ...
	    defaults = {
		    ...
		    animation: true,                      // true, comma separated string, false or object { in: 'fadeIn', out: 'fadeOut' } (default: true which is equal to > 'fadeInDownBig,fadeOutUpBig')
        ...
        defaultTemplate = '<div class="modal">' +
        ...
        function Modal(options) {
            ...
            var self, getTemplate, bindLocals, bindMethods, finish, init,
                ctrl, isDefault, closing, element, opts, getContent, normalizeAnimation,
                show, close, ok, destroy, scope, visibility, loadTemplate, compile,
                body, backdrop, closeComplete, showComplete, bindScope, contentHtml,
                onKey, dialog, resetVisibility, _requestAnimationFrame,
                _cancelAnimationFrame, lastAnimation, setOptions, initializing;
            ...
            /* close the modal */
            close = function close($event, callback, preventAnimation) {
            ...
            ok = function ok(callback) {
                ...
                close(null, function () {
                    if (opts.onOk && angular.isFunction(opts.onOk))
                        opts.onOk(self);
                });
            ...
            setOptions = function setOptions(key, value, reinit) {
            ...
            finish = function finish(finishShow) {
...
modal.directive('aiModal', ['AiModalFactory', function (AiModalFactory) {

    var Modal = AiModalFactory;
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            var modal, defaults, init, bindEvents, dataOptions;
            ...
            defaults = {
                ...
                show: false,                          // show the modal on init.
                container: 'body',                    // the html container to attach the modal to.
                animation: true,                      // true, comma separated string or object { in: 'fadeIn', out: 'fadeOut' } (default: true which is equal to > 'fadeInDownBig,fadeOutUpBig')
                backdropAnimation: true,              // true, comma separated string or object { in: 'fadeIn', out: 'fadeOut' } (default: true which is equal to > 'fadeIn,fadeOut')
                backdrop: true,                       // when true on backdrop click modal is closed static to disable backdrop click event.
                backdropCss: 'rgba(51,51,51,0.7)',    // adds 'background:' css style, can use url, rgba, solid color.
                keyboard: true,                       // when true esc closed modal if backdrop is not equal to 'static'
                header: true,                         // whether to show the default template's header.
